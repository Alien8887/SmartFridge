...
export function MobileMenu({ isOpen, activeView, setActiveView, onClose, theme, darkMode }: MobileMenuProps) {
            ...
            return (
              <li key={id}>
                <button
                  ...
                  type="button"
                  className={`w-full flex flex-col gap-1 px-4 py-3 rounded-xl transition-all text-left ${
